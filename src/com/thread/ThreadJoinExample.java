...
public class ThreadJoinExample {
    public static void main(final String[] args) throws InterruptedException {
       ...
       final TaskTemp task1 = new TaskTemp(500l);
       final TaskTemp task2 = new TaskTemp(1000l);
       final TaskTemp task3 = new TaskTemp(2000l);
       final TaskTemp task4 = new TaskTemp(50l);
...
class TaskTemp implements Runnable {
     private long sleep; 
     private int sum;
 
     public TaskTemp(final long sleep) {
         this.sleep = sleep;
     }
